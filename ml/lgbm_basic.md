---
layout: page
title: LightGBM basic example using Sklearn API
noindex: true
---


### Description:
- Training a LightGBM classifier with early stopping using Sklearn API.

### References:
- [LightGBM SKLearn API ](https://lightgbm.readthedocs.io/en/latest/Python-API.html)
