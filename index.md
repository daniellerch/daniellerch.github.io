...
- **[Practical attack to Steghide](https://daniellerch.me/stego/aletheia/steghide-attack-en/)**: Blog post about the dectection of JPEG images which contain hidden data using Steghide, using the Aletheia steganalysis tool.
  <br>[ *Updated on 2021-06-03* ]
