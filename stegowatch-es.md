...
| Familia técnica | Software que usa esta técnica | Dominio | Resistencia a detección |
|---|---|---|---|
| [Esteganografía generativa](/stegowatch/generative-steganography-es/) | [SteganoGAN](https://github.com/DAI-Lab/SteganoGAN) | Sin comprimir | <span class="stegowatch-rating stegowatch-rating-1" title="Muy fácil de detectar"><span class="stegowatch-rating-bars" aria-hidden="true"><span></span><span></span><span></span><span></span><span></span></span><span class="stegowatch-rating-label">Muy fácil de detectar</span></span> |
| [LSB replacement](/stegowatch/lsb-replacement-es/) | [OpenStego](https://www.openstego.com), [OpenPuff](https://embeddedsw.net/OpenPuff_Steganography_Home.html) | Sin comprimir | <span class="stegowatch-rating stegowatch-rating-4" title="Parcialmente detectable"><span class="stegowatch-rating-bars" aria-hidden="true"><span></span><span></span><span></span><span></span><span></span></span><span class="stegowatch-rating-label">Parcialmente detectable</span></span> |
...
| [J-UNIWARD](/stegowatch/j-uniward-es/) | [HStego < 0.4](https://github.com/daniellerch/hstego) | JPEG | <span class="stegowatch-rating stegowatch-rating-4" title="Parcialmente detectable"><span class="stegowatch-rating-bars" aria-hidden="true"><span></span><span></span><span></span><span></span><span></span></span><span class="stegowatch-rating-label">Parcialmente detectable</span></span> |
| [J-UNIWARD + Cost Polarization](/stegowatch/j-uniward-cost-polarization-es/) | [HStego 0.4](https://github.com/daniellerch/hstego) | JPEG | <span class="stegowatch-rating stegowatch-rating-5" title="Difícil de detectar"><span class="stegowatch-rating-bars" aria-hidden="true"><span></span><span></span><span></span><span></span><span></span></span><span class="stegowatch-rating-label">Difícil de detectar</span></span> |
